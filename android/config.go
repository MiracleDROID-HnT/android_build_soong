...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.ProductVariables.Mdroid.Specific_camera_parameter_library)
}
...
func (c *deviceConfig) QTIAudioPath() string {
	return String(c.config.ProductVariables.Mdroid.QTIAudioPath)
}

func (c *deviceConfig) QTIDisplayPath() string {
	return String(c.config.ProductVariables.Mdroid.QTIDisplayPath)
}

func (c *deviceConfig) QTIMediaPath() string {
	return String(c.config.ProductVariables.Mdroid.QTIMediaPath)
}
